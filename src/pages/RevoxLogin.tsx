        ...
        <div className="animate-fade-in delay-200 space-y-8">
          ...
          <div className="space-y-3">
            ...
            <Button
              type="button"
              variant="outline"
              className="w-full h-12 rounded-xl border border-border/30 hover:border-gray-400 transition-all duration-200 group bg-black text-white hover:bg-gray-800"
            >
              <div className="flex items-center justify-center gap-3">
